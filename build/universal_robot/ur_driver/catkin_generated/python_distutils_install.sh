...
echo_and_run cd "/home/saisriteja/htic_spine_surgery_robotics/src/universal_robot/ur_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/saisriteja/htic_spine_surgery_robotics/src/universal_robot/ur_driver/setup.py" \
     \
    build --build-base "/home/saisriteja/htic_spine_surgery_robotics/build/universal_robot/ur_driver" \
    install \
    --root="${DESTDIR-/}" \
